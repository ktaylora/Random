...
if echo $in | grep -q "evh"; then
  ...
  gdal_calc.py -A $1 --outfile=shrub_perc_cover.tif --calc="(((A>111))+((A<119)))*(((A-110)*10)+5)" --type="Int16"
  gdal_calc.py -A $1 --outfile=tree_perc_cover.tif --calc="(((A>101))+((A<109)))*(((A-100)*10)+5)" --type="Int16"
fi
